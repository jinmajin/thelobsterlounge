var profileResources = {
  ...
  jazzyJeff: {
    ...
    upcomingPerformances: [
      {date: {month: "03", day: "05", year: "2015"}, location: "Harvard Square", details: "I'll be playing my piano in the middle of the square from 5:00pm to 9:00pm"},
      {date: {month: "03", day: "10", year: "2015"}, location: "Kendall Station", details: "I'll play my guitar on the inbound platform all day long"},
      {date: {month: "04", day: "01", year: "2015"}, location: "Boston Common Park", details: "I'll be playing guitar by the green line station entrance"}
    ],
    media: [
  ...
  usTheDuo: {
    ...
    upcomingPerformances: [
      {date: {month: "04", day: "13", year: "2015"}, location: "Museum of Arts & Design", details: "We'll be playing some wicked sweet jams in front of the Museum."},
      {date: {month: "04", day: "14", year: "2015"}, location: "Central Park", details: "We'll be playing some moderately tasty jams."},
    ],
    media: [
  ...
  jugglingGeorge: {
    ...
    upcomingPerformances: [
      {date: {month:"04", day: "13", year: "2015"}, location: "Kendall Square", details: "I'll be juggling and playing my piano in the outbound side of the T-station."},
      {date: {month:"04", day: "14", year: "2015"}, location: "MIT Kresge Auditorium", details: "I'll be joining the MIT Juggling Club to do some amazing juggling."},
    ],
    media: [
  ...
  acrobaticAdam: {
    ...
    upcomingPerformances: [
      {date: {month:"04", day: "13", year: "2015"}, location: "Battery Park", details: "Me and the NYC Acrobatics Street Performers group will be doing some sweet stunts."},
      {date: {month:"04", day: "14", year: "2015"}, location: "Rockefeller Center", details: "I'll be jumping over more things in front of the Rockefeller Center."},
    ],
    media: [

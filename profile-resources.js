var profileResources = {
  ...
  jazzyJeff: {
    ...
    media: [
      {type: 'video', src: "https://www.youtube.com/embed/eeHEGK0vaqA"},
  ...
  usTheDuo: {
    ...
    media: [
      {type: 'video', src: "https://www.youtube.com/embed/O1mmOm-1X4Q"},
  ...
  jugglingGeorge: {
    ...
    upcomingPerformances: [
      ...
      {date: "April 14, 2015", location: "MIT's Kresge Field", details: "I'll be joining the MIT Juggling Club to do some amazing juggling."},
    ],
    media: [
      {type: 'video', src: "https://www.youtube.com/embed/AxHt4-GDvck"},
      {type: 'video', src: "https://www.youtube.com/embed/OwPcwPstcH4"},
  ...
  acrobaticAdam: {
    ...
    upcomingPerformances: [
      ...
      {date: "April 14, 2015", location: "Central Park", details: "I'll be jumping over more things."},
    ],
    media: [
      {type: 'video', src: "https://www.youtube.com/embed/LaYEMUAPUf0"},
      {type: 'video', src: "https://www.youtube.com/embed/bw1G_BoBbJs"},
